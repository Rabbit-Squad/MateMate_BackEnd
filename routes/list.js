...
router.get('/list', (req, res) => {
    const sql = `SELECT User.nickname, Post.id, Post.deadline, Post.location, Post.min_num, Post.cur_num, Post.title, Post.content, Post.closed FROM Post INNER JOIN User ON Post.writer = User.id ORDER BY Post.id`;
